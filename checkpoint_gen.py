...
def get_courses(api_key, current, end_goal, num_courses=5):
    ...
    for course_name in course_names[:num_courses]:
        ...
        if trusted:
            courses[course_name] = trusted[0]
    
    return courses


courses = get_courses(api_key = "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", current = "i am currently pursuing a computer science degree", end_goal = "I want to master data structures", num_courses=5)
print(courses)